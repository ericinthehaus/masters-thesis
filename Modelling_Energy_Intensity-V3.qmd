...
```{r}
rf_tune_small <- train(
  energy_int ~ Eolica + prec + tmin + mas + ns + pop + 
...
partial(rf_tune_small, pred.var = "pop", plot = T, rug = TRUE)
```
...
```{r , fig.height=7}
DataExplorer::plot_correlation(test_results, type = "all", ggtheme = theme_classic())
